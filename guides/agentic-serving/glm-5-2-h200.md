...
The model server manifests live under the [wide-ep guide](../wide-ep/README.md)
...
| Routing                  | Dual GPU+CPU prefix-cache scoring ([`glm-5.2-overrides.values.yaml`](../wide-ep/router/glm-5.2-overrides.values.yaml)) |
...
| ----------------- | ---------------------------------------------- | ------------------------------------------------------ |
| NVIDIA GPU (vLLM) | `modelserver/gpu/vllm/glm-5-2/`                | Composes `wide-ep/modelserver/gpu/vllm-glm-5.2/` (H200, P/D disaggregated) |
...
([`glm-5.2-overrides.values.yaml`](../wide-ep/router/glm-5.2-overrides.values.yaml)) on the
wide-ep values: a GPU prefix-cache scorer (weight 5), a CPU prefix-cache scorer (weight 2,
...
helm install ${GUIDE_NAME} \
    ...
    -f ${REPO_ROOT}/guides/wide-ep/router/wide-ep.values.yaml \
    -f ${REPO_ROOT}/guides/wide-ep/router/glm-5.2-overrides.values.yaml \
...
`guides/wide-ep/modelserver/gpu/vllm-glm-5.2/deployments/benchmark/` reproduce the measured
configurations. See the
[model server README](../wide-ep/modelserver/gpu/vllm-glm-5.2/README.md#benchmark-overlays)
...
`guides/wide-ep/modelserver/gpu/vllm-glm-5.2/deployments/`, applied the same way as the
default:

```bash
kubectl apply -n ${NAMESPACE} \
    -k ${REPO_ROOT}/guides/wide-ep/modelserver/gpu/vllm-glm-5.2/deployments/<deployment>
```
...
See the [model server README](../wide-ep/modelserver/gpu/vllm-glm-5.2/README.md) for the
...
```bash
NAMESPACE=${NAMESPACE} bash ${REPO_ROOT}/guides/wide-ep/monitoring/apply-scrape-configs.sh
```
